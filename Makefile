...
scenario7/send:
	docker compose exec a-client     /send.sh user1@a.test user1@dmarc.b.test dkim.smtp.a.test scenario7  user1@fail.a.test

## dmarc=pass(dkim=pass, spf=pass, DKIM not aligned)
scenario8/up: scenario6/up
scenario8/send:
	docker compose exec a-client     /send.sh user1@external.x.test user1@dmarc.b.test dkim.smtp.a.test scenario8 user1@external.x.test

## dmarc=fail(dkim=pass, spf=pass, SPF/DKIM not aligned)
scenario9/up: scenario6/up
scenario9/send:
	docker compose exec a-client     /send.sh user1@x.test user1@dmarc.b.test dkim.smtp.a.test scenario9 user1@a.test
